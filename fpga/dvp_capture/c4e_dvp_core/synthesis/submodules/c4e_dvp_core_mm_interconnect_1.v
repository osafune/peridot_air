// c4e_dvp_core_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module c4e_dvp_core_mm_interconnect_1 (
		...
		output wire [1:0]  cam_s1_address,                                      //                                        cam_s1.address
		output wire        cam_s1_write,                                        //                                              .write
		output wire        cam_s1_read,                                         //                                              .read
		input  wire [31:0] cam_s1_readdata,                                     //                                              .readdata
		output wire [31:0] cam_s1_writedata,                                    //                                              .writedata
		input  wire        cam_s1_waitrequest,                                  //                                              .waitrequest
	...
	wire   [9:0] vga_csr_agent_m0_address;                                                // vga_csr_agent:m0_address -> vga_csr_translator:uav_address
	...
	wire  [82:0] vga_csr_agent_rf_source_data;                                            // vga_csr_agent:rf_source_data -> vga_csr_agent_rsp_fifo:in_data
	...
	wire  [82:0] vga_csr_agent_rsp_fifo_out_data;                                         // vga_csr_agent_rsp_fifo:out_data -> vga_csr_agent:rf_sink_data
	...
	wire  [81:0] cmd_mux_001_src_data;                                                    // cmd_mux_001:src_data -> vga_csr_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                   // vga_csr_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                 // cmd_mux_001:src_channel -> vga_csr_agent:cp_channel
	...
	wire  [31:0] cam_s1_agent_m0_readdata;                                                // cam_s1_translator:uav_readdata -> cam_s1_agent:m0_readdata
	wire         cam_s1_agent_m0_waitrequest;                                             // cam_s1_translator:uav_waitrequest -> cam_s1_agent:m0_waitrequest
	wire         cam_s1_agent_m0_debugaccess;                                             // cam_s1_agent:m0_debugaccess -> cam_s1_translator:uav_debugaccess
	wire   [9:0] cam_s1_agent_m0_address;                                                 // cam_s1_agent:m0_address -> cam_s1_translator:uav_address
	wire   [3:0] cam_s1_agent_m0_byteenable;                                              // cam_s1_agent:m0_byteenable -> cam_s1_translator:uav_byteenable
	wire         cam_s1_agent_m0_read;                                                    // cam_s1_agent:m0_read -> cam_s1_translator:uav_read
	wire         cam_s1_agent_m0_readdatavalid;                                           // cam_s1_translator:uav_readdatavalid -> cam_s1_agent:m0_readdatavalid
	wire         cam_s1_agent_m0_lock;                                                    // cam_s1_agent:m0_lock -> cam_s1_translator:uav_lock
	wire  [31:0] cam_s1_agent_m0_writedata;                                               // cam_s1_agent:m0_writedata -> cam_s1_translator:uav_writedata
	wire         cam_s1_agent_m0_write;                                                   // cam_s1_agent:m0_write -> cam_s1_translator:uav_write
	wire   [2:0] cam_s1_agent_m0_burstcount;                                              // cam_s1_agent:m0_burstcount -> cam_s1_translator:uav_burstcount
	wire         cam_s1_agent_rf_source_valid;                                            // cam_s1_agent:rf_source_valid -> cam_s1_agent_rsp_fifo:in_valid
	wire  [82:0] cam_s1_agent_rf_source_data;                                             // cam_s1_agent:rf_source_data -> cam_s1_agent_rsp_fifo:in_data
	wire         cam_s1_agent_rf_source_ready;                                            // cam_s1_agent_rsp_fifo:in_ready -> cam_s1_agent:rf_source_ready
	wire         cam_s1_agent_rf_source_startofpacket;                                    // cam_s1_agent:rf_source_startofpacket -> cam_s1_agent_rsp_fifo:in_startofpacket
	wire         cam_s1_agent_rf_source_endofpacket;                                      // cam_s1_agent:rf_source_endofpacket -> cam_s1_agent_rsp_fifo:in_endofpacket
	wire         cam_s1_agent_rsp_fifo_out_valid;                                         // cam_s1_agent_rsp_fifo:out_valid -> cam_s1_agent:rf_sink_valid
	wire  [82:0] cam_s1_agent_rsp_fifo_out_data;                                          // cam_s1_agent_rsp_fifo:out_data -> cam_s1_agent:rf_sink_data
	wire         cam_s1_agent_rsp_fifo_out_ready;                                         // cam_s1_agent:rf_sink_ready -> cam_s1_agent_rsp_fifo:out_ready
	wire         cam_s1_agent_rsp_fifo_out_startofpacket;                                 // cam_s1_agent_rsp_fifo:out_startofpacket -> cam_s1_agent:rf_sink_startofpacket
	wire         cam_s1_agent_rsp_fifo_out_endofpacket;                                   // cam_s1_agent_rsp_fifo:out_endofpacket -> cam_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                   // cmd_mux_003:src_valid -> cam_s1_agent:cp_valid
	wire  [81:0] cmd_mux_003_src_data;                                                    // cmd_mux_003:src_data -> cam_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                   // cam_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                 // cmd_mux_003:src_channel -> cam_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                           // cmd_mux_003:src_startofpacket -> cam_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                             // cmd_mux_003:src_endofpacket -> cam_s1_agent:cp_endofpacket
	...
	wire  [81:0] vga_csr_agent_rp_data;                                                   // vga_csr_agent:rp_data -> router_002:sink_data
	...
	wire         cam_s1_agent_rp_valid;                                                   // cam_s1_agent:rp_valid -> router_004:sink_valid
	wire  [81:0] cam_s1_agent_rp_data;                                                    // cam_s1_agent:rp_data -> router_004:sink_data
	wire         cam_s1_agent_rp_ready;                                                   // router_004:sink_ready -> cam_s1_agent:rp_ready
	wire         cam_s1_agent_rp_startofpacket;                                           // cam_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         cam_s1_agent_rp_endofpacket;                                             // cam_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire         cam_s1_agent_rdata_fifo_src_valid;                                       // cam_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] cam_s1_agent_rdata_fifo_src_data;                                        // cam_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         cam_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_003:in_0_ready -> cam_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                       // avalon_st_adapter_003:out_0_valid -> cam_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                        // avalon_st_adapter_003:out_0_data -> cam_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                       // cam_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                       // avalon_st_adapter_003:out_0_error -> cam_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (peri_clk_clk_clk),                                    //                      clk.clk
		.reset                  (peripheral_bridge_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (cam_s1_agent_m0_address),                             // avalon_universal_slave_0.address
		.uav_burstcount         (cam_s1_agent_m0_burstcount),                          //                         .burstcount
		.uav_read               (cam_s1_agent_m0_read),                                //                         .read
		.uav_write              (cam_s1_agent_m0_write),                               //                         .write
		.uav_waitrequest        (cam_s1_agent_m0_waitrequest),                         //                         .waitrequest
		.uav_readdatavalid      (cam_s1_agent_m0_readdatavalid),                       //                         .readdatavalid
		.uav_byteenable         (cam_s1_agent_m0_byteenable),                          //                         .byteenable
		.uav_readdata           (cam_s1_agent_m0_readdata),                            //                         .readdata
		.uav_writedata          (cam_s1_agent_m0_writedata),                           //                         .writedata
		.uav_lock               (cam_s1_agent_m0_lock),                                //                         .lock
		.uav_debugaccess        (cam_s1_agent_m0_debugaccess),                         //                         .debugaccess
		.av_address             (cam_s1_address),                                      //      avalon_anti_slave_0.address
		.av_write               (cam_s1_write),                                        //                         .write
		.av_read                (cam_s1_read),                                         //                         .read
		.av_readdata            (cam_s1_readdata),                                     //                         .readdata
		.av_writedata           (cam_s1_writedata),                                    //                         .writedata
		.av_waitrequest         (cam_s1_waitrequest),                                  //                         .waitrequest
		.av_begintransfer       (),                                                    //              (terminated)
		.av_beginbursttransfer  (),                                                    //              (terminated)
		.av_burstcount          (),                                                    //              (terminated)
		.av_byteenable          (),                                                    //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (peri_clk_clk_clk),                                    //             clk.clk
		.reset                   (peripheral_bridge_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (cam_s1_agent_m0_address),                             //              m0.address
		.m0_burstcount           (cam_s1_agent_m0_burstcount),                          //                .burstcount
		.m0_byteenable           (cam_s1_agent_m0_byteenable),                          //                .byteenable
		.m0_debugaccess          (cam_s1_agent_m0_debugaccess),                         //                .debugaccess
		.m0_lock                 (cam_s1_agent_m0_lock),                                //                .lock
		.m0_readdata             (cam_s1_agent_m0_readdata),                            //                .readdata
		.m0_readdatavalid        (cam_s1_agent_m0_readdatavalid),                       //                .readdatavalid
		.m0_read                 (cam_s1_agent_m0_read),                                //                .read
		.m0_waitrequest          (cam_s1_agent_m0_waitrequest),                         //                .waitrequest
		.m0_writedata            (cam_s1_agent_m0_writedata),                           //                .writedata
		.m0_write                (cam_s1_agent_m0_write),                               //                .write
		.rp_endofpacket          (cam_s1_agent_rp_endofpacket),                         //              rp.endofpacket
		.rp_ready                (cam_s1_agent_rp_ready),                               //                .ready
		.rp_valid                (cam_s1_agent_rp_valid),                               //                .valid
		.rp_data                 (cam_s1_agent_rp_data),                                //                .data
		.rp_startofpacket        (cam_s1_agent_rp_startofpacket),                       //                .startofpacket
		...
		.rf_sink_ready           (cam_s1_agent_rsp_fifo_out_ready),                     //         rf_sink.ready
		.rf_sink_valid           (cam_s1_agent_rsp_fifo_out_valid),                     //                .valid
		.rf_sink_startofpacket   (cam_s1_agent_rsp_fifo_out_startofpacket),             //                .startofpacket
		.rf_sink_endofpacket     (cam_s1_agent_rsp_fifo_out_endofpacket),               //                .endofpacket
		.rf_sink_data            (cam_s1_agent_rsp_fifo_out_data),                      //                .data
		.rf_source_ready         (cam_s1_agent_rf_source_ready),                        //       rf_source.ready
		.rf_source_valid         (cam_s1_agent_rf_source_valid),                        //                .valid
		.rf_source_startofpacket (cam_s1_agent_rf_source_startofpacket),                //                .startofpacket
		.rf_source_endofpacket   (cam_s1_agent_rf_source_endofpacket),                  //                .endofpacket
		.rf_source_data          (cam_s1_agent_rf_source_data),                         //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (cam_s1_agent_rdata_fifo_src_ready),                   //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (cam_s1_agent_rdata_fifo_src_valid),                   //                .valid
		.rdata_fifo_src_data     (cam_s1_agent_rdata_fifo_src_data),                    //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) cam_s1_agent_rsp_fifo (
		.clk               (peri_clk_clk_clk),                                    //       clk.clk
		.reset             (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (cam_s1_agent_rf_source_data),                         //        in.data
		.in_valid          (cam_s1_agent_rf_source_valid),                        //          .valid
		.in_ready          (cam_s1_agent_rf_source_ready),                        //          .ready
		.in_startofpacket  (cam_s1_agent_rf_source_startofpacket),                //          .startofpacket
		.in_endofpacket    (cam_s1_agent_rf_source_endofpacket),                  //          .endofpacket
		.out_data          (cam_s1_agent_rsp_fifo_out_data),                      //       out.data
		.out_valid         (cam_s1_agent_rsp_fifo_out_valid),                     //          .valid
		.out_ready         (cam_s1_agent_rsp_fifo_out_ready),                     //          .ready
		.out_startofpacket (cam_s1_agent_rsp_fifo_out_startofpacket),             //          .startofpacket
		.out_endofpacket   (cam_s1_agent_rsp_fifo_out_endofpacket),               //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	c4e_dvp_core_mm_interconnect_1_router router (
	...
	c4e_dvp_core_mm_interconnect_1_router_001 router_001 (
	...
	c4e_dvp_core_mm_interconnect_1_router_001 router_002 (
	...
	c4e_dvp_core_mm_interconnect_1_router_001 router_003 (
	...
	c4e_dvp_core_mm_interconnect_1_router_001 router_004 (
		.sink_ready         (cam_s1_agent_rp_ready),                               //      sink.ready
		.sink_valid         (cam_s1_agent_rp_valid),                               //          .valid
		.sink_data          (cam_s1_agent_rp_data),                                //          .data
		.sink_startofpacket (cam_s1_agent_rp_startofpacket),                       //          .startofpacket
		.sink_endofpacket   (cam_s1_agent_rp_endofpacket),                         //          .endofpacket
		.clk                (peri_clk_clk_clk),                                    //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c4e_dvp_core_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (peri_clk_clk_clk),                                    //        clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	c4e_dvp_core_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (peri_clk_clk_clk),                                    //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c4e_dvp_core_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (peri_clk_clk_clk),                                    //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c4e_dvp_core_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (peri_clk_clk_clk),                                    //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c4e_dvp_core_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (peri_clk_clk_clk),                                    //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c4e_dvp_core_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (peri_clk_clk_clk),                                    //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c4e_dvp_core_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (peri_clk_clk_clk),                                    //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c4e_dvp_core_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (peri_clk_clk_clk),                                    //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c4e_dvp_core_mm_interconnect_1_rsp_demux rsp_demux_003 (
		.clk                (peri_clk_clk_clk),                                    //       clk.clk
		.reset              (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c4e_dvp_core_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (peri_clk_clk_clk),                                    //       clk.clk
		.reset               (peripheral_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	c4e_dvp_core_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (peri_clk_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (peripheral_bridge_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (cam_s1_agent_rdata_fifo_src_data),                    //     in_0.data
		.in_0_valid     (cam_s1_agent_rdata_fifo_src_valid),                   //         .valid
		.in_0_ready     (cam_s1_agent_rdata_fifo_src_ready),                   //         .ready
